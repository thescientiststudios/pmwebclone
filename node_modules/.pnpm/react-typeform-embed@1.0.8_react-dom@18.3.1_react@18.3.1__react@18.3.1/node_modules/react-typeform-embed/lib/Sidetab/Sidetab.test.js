...
var _Sidetab = _interopRequireDefault(require("./Sidetab"));
...
describe('<Sidetab />', () => {
  it('should render without breaking', () => {
    const wrapper = (0, _enzyme.shallow)( /*#__PURE__*/_react.default.createElement(_Sidetab.default, {
      id: formId
    }));
  ...
  it('should have the correct id prop', () => {
    const wrapper = (0, _enzyme.mount)( /*#__PURE__*/_react.default.createElement(_Sidetab.default, {
      id: formId
    }));
